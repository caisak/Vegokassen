  ...
  const closeModal = () => {
    ...
    return (
      ...
      <BigHowCardReversed
        ...
        imageSrc="Images/bellpeppers.jpg"
      ...
      <BigHowCardReversed
        ...
        imageSrc="Images/fresh_greens2.jpg"
        imageAlt="Grönsaker"
      />
      <StyledFillerCard>
        <StyledFillerText>
        ...
        <StyledFillerImg src="Images/farm.jpeg" alt="Närbild på växter" />
      </StyledFillerCard>
    </div>
  );
}
